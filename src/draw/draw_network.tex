...
\pic at (co-gcat01) {Ball={name=gcat01,%
        ...
        radius=2.5,logo=cat}};
\coordinate (cat01-top) at ([yshift=80pt] gcat01-north);
\draw [connection] (rb5-southeast)
	-- node {\midarrow} (cat01-top -| rb5-southeast)
	-- (cat01-top)
	-- node {\midarrow} (gcat01-north);
\draw [connection]
	(rb4-southeast)
	-- node {\midarrow} (cat01-top -| rb4-southeast)
	-- (cat01-top);
...
\pic at (co-gcat02) {Ball={name=gcat02,%
        fill=\CatColor,opacity=0.6,%
        radius=2.5,logo=cat}};
\coordinate (cat02-top) at ([yshift=80pt] gcat02-north);
\draw [connection](cat02-top -| rb4-southeast)
	-- (cat02-top)
	-- node {\midarrow} (gcat02-north);
\draw [connection] (rb3-southeast)
	-- node {\midarrow} (cat02-top -| rb3-southeast)
	-- (cat02-top);
...
\pic at (co-gcat03) {Ball={name=gcat03,%
        fill=\CatColor,opacity=0.6,%
        radius=2.5,logo=cat}};
\coordinate (cat03-top) at ([yshift=80pt] gcat03-north);
\draw [connection](cat03-top -| rb3-southeast)
	-- (cat03-top)
	-- node {\midarrow} (gcat03-north);
\draw [connection] (rb2-southeast)
	-- node {\midarrow} (cat03-top -| rb2-southeast)
	-- (cat03-top);
...
\pic at (co-gcat04) {Ball={name=gcat04,%
        fill=\CatColor,opacity=0.6,%
        radius=2.5,logo=cat}};
\coordinate (cat04-top) at ([yshift=80pt] gcat04-north);
\draw [connection](cat04-top -| rb2-southeast)
	-- (cat04-top)
	-- node {\midarrow} (gcat04-north);
\draw [connection]
	(rb1-southeast)
	-- node {\midarrow} (cat04-top -| rb1-southeast)
	-- (cat04-top);
