...
%% step 2
\pic[shift={(-5,0,0)}] at (gc1-west) {LeftBandedCylinder={name=grb2,caption=x3,%
...
\pic[shift={(-1,-6,0)}] at (grb2-west) {Cylinder={name=fv2,%
	...
	opacity=0.5,height=25,width={1},depth=25}};
%% step 3
\pic[shift={(-4,0,0)}] at (gc2-west) {LeftBandedCylinder={name=grb3,caption=x3,%
...
\draw [connection]  (up2-southeast) -- (up2-southeast |- uds2-west) -- node {\midarrow} (uds2-west);
\draw [connection]  (up3-southeast) -- (up3-southeast |- uds3-west) -- node {\midarrow} (uds3-west);
...
\draw [connection] (rb5-southeast)
	-- node {\midarrow} (cat01-topright -| rb5-southeast)
	-- (cat01-topright)
	-- node {\midarrow} (gcat01-north);
\draw [connection] (rb4-southeast)
	-- node {\midarrow} (cat01-topleft -| rb4-southeast)
	-- (cat01-topleft)
	-- node {\midarrow} (gcat01-north);
\draw [connection] (grb0-west) -- node{\midarrow} (gcat01-east);
\draw [connection] (gcat01-west) -- node{\midarrow} (grb1-east);
\path (grb1-west) -- (gc1-east) coordinate[pos=0.1] (co-split01);
\draw [connection] (grb1-west) -- node {\midarrow} (gc1-east);
\draw [connection] (co-split01)
	-- (fv1-east -| co-split01)
	-- node {\midarrow} (fv1-east);
\coordinate (cat01-top) at ([yshift=90pt] gcat01-north);
\draw [connection] (up1-southeast)
	-- (cat01-top -| up1-southeast)
	-- node {\midarrow} (cat01-top)
	-- node {\midarrow} (gcat01-north);
%%
\path (gc1-west) -- (grb2-east) coordinate[pos=0.5] (co-gcat02);
...
\draw [connection](cat02-topright -| rb4-southeast)
	-- (cat02-topright)
	-- node {\midarrow} (gcat02-north);
\draw [connection] (rb3-southeast)
	-- node {\midarrow} (cat02-topleft -| rb3-southeast)
	-- (cat02-topleft)
	-- node {\midarrow} (gcat02-north);
\draw [connection] (gc1-west) -- node{\midarrow} (gcat02-east);
\draw [connection] (gcat02-west) -- node{\midarrow} (grb2-east);
\path (grb2-west) -- (gc2-east) coordinate[pos=0.1] (co-split02);
\draw [connection] (grb2-west) -- node {\midarrow} (gc2-east);
\draw [connection] (co-split02)
	-- (fv2-east -| co-split02)
	-- node {\midarrow} (fv2-east);
\coordinate (cat02-top) at ([yshift=100pt] gcat02-north);
\draw [connection] (up2-southeast)
	-- (cat02-top -| up2-southeast)
	-- node {\midarrow} (cat02-top)
	-- node {\midarrow} (gcat02-north);
%%
\path (gc2-west) -- (grb3-east) coordinate[pos=0.5] (co-gcat03);
...
\draw [connection](cat03-topright -| rb3-southeast)
	-- (cat03-topright)
	-- node {\midarrow} (gcat03-north);
\draw [connection] (rb2-southeast)
	-- node {\midarrow} (cat03-topleft -| rb2-southeast)
	-- (cat03-topleft)
	-- node {\midarrow} (gcat03-north);
\draw [connection] (gc2-west) -- node{\midarrow} (gcat03-east);
\draw [connection] (gcat03-west) -- node{\midarrow} (grb3-east);
\path (grb3-west) -- (gc3-east) coordinate[pos=0.1] (co-split03);
\draw [connection] (grb3-west) -- node {\midarrow} (gc3-east);
\draw [connection] (co-split03)
	-- (fv3-east -| co-split03)
	-- node {\midarrow} (fv3-east);
\coordinate (cat03-top) at ([yshift=110pt] gcat03-north);
\draw [connection] (up2-southeast)
	-- (cat03-top -| up2-southeast)
	-- node {\midarrow} (cat03-top)
	-- node {\midarrow} (gcat03-north);
%%
\path (gc3-west) -- (grb4-east) coordinate[pos=0.5] (co-gcat04);
...
\draw [connection](cat04-topright -| rb2-southeast)
	-- (cat04-topright)
	-- node {\midarrow} (gcat04-north);
\draw [connection]
	(rb1-southeast)
	-- node {\midarrow} (cat04-topleft -| rb1-southeast)
	-- (cat04-topleft)
	-- node {\midarrow} (gcat04-north);
\draw [connection] (gc3-west) -- node{\midarrow} (gcat04-east);
...
\coordinate (cat04-top) at ([yshift=120pt] gcat04-north);
\draw [connection] (up3-southeast)
	-- (cat04-top -| up3-southeast)
	-- node {\midarrow} (cat04-top)
	-- node {\midarrow} (gcat04-north);
