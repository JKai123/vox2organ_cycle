...
\def\UpsampleColor{rgb:blue,2;green,3;black,0.3}
\def\FcColor{rgb:blue,5;red,2.5;white,5}
\def\FcReluColor{rgb:blue,5;red,5;white,4}
\def\SoftmaxColor{rgb:magenta,5;black,7}
\def\GraphConvColor{rgb:grey,5;red,2.5}
...
\pic[shift={(1,0,0)}] at (urb1-east) {Box={name=cf,%
	xlabel={"seg.\ classes","dummy"},zlabel=I,fill=\ConvColor,%
...
\pic[shift={(0,0,0)}] at (uds2-east) {Box={name=ds2,%
	xlabel={{"seg.\ classes", "dummy"}},fill=\ConvColor,opacity=0.5,height=40,width=1,depth=40}};
