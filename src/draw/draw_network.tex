...
%% Mesh template
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\pic[shift={(4,0,0)}] at (grb0-east) {Ball={name=template,%
	fill={rgb:black,5}, logo= ,%
        radius=10}};
\draw [connection] (template-west) -- node {\midarrow} (grb0-east);

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Output meshes and images
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\node[inner sep=0pt] (img-in) at ([xshift=-100] c1-west)
    {\includegraphics[width=.25\textwidth]{mri_half.png}};
\draw [connection] (img-in.east) -- node {\midarrow} (c1-west);
\node[inner sep=0pt] (mout1) at ([yshift=-50, xshift=-30] mout-01)
    {\includegraphics[width=.25\textwidth]{hemisphere.png}};
